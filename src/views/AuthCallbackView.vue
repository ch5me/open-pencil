  ...
  <div class="flex min-h-screen items-center justify-center bg-canvas p-6">
    <div class="w-full max-w-md space-y-8 rounded-xl border border-border bg-panel p-8 shadow-lg">
      ...
      <div v-if="status === 'loading'" class="text-center">
        <div
          class="mx-auto mb-4 size-12 animate-spin rounded-full border-4 border-primary border-t-transparent"
        />
      ...
      <div v-else-if="status === 'success'" class="text-center">
        <div
          class="mx-auto mb-4 flex size-12 items-center justify-center rounded-full bg-green-100"
        >
      ...
      <div v-else class="text-center">
        ...
        <button
          ...
          class="mt-6 rounded-lg bg-accent px-4 py-2 text-sm font-medium text-white transition-colors hover:brightness-110"
