...
import type { PencilScenarioId } from '@/app/pencil/types'
...
const meta = {
  ...
  render: (args) => ({
    ...
    setup: () => ({ args }),
    template:
      '<div style="height: 800px; display: flex; justify-content: flex-end; background: #e8e4db"><PencilDiagnosticsPanel v-bind="args" /></div>'
  })
