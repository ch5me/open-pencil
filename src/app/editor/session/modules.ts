...
export function createEditorStoreModules(
  ...
  return {
    ...
    restoreHostedSessionDocument: documentIO.restoreHostedSessionDocument,
    hasUnsavedChanges: documentIO.hasUnsavedChanges,
    hasHostedDocumentSource: documentIO.hasHostedDocumentSource,
    canUseHostedSave: documentIO.canUseHostedSave,
