...
- [ ] 1. Define hosted operating modes and canonical identities
...
- [ ] 2. Unify the ELF auth package source of truth and payload contract
...
- [ ] 3. Define public auth naming doctrine and rename map
...
- [ ] 5. Add document persistence adapter boundary for local and hosted modes
...
- [ ] 7. Model hosted document schema, ownership, and migration rules
...
- [ ] 8. Establish feature flags and environment topology for hosted rollout
...
- [ ] 9. Align Firefly Cloud consumers to the unified auth package contract
