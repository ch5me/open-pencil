...
Headless CLI уже поддерживает `analyze colors/typography/spacing/clusters`. Далее: интеграция с Forgejo Actions для автоматического линтинга дизайна и визуальной регрессии в пулл-реквестах.
