...
Le CLI headless supporte déjà `analyze colors/typography/spacing/clusters`. Prochaine étape : intégration Forgejo Actions pour le linting de design automatisé et la régression visuelle dans les PRs.
